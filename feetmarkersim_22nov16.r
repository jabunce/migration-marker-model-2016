...
feet_marker_sim(
    ...
    g=0.2, #extra coordination benefit among mutualists
    h=0.5, #mis-coordination cost for mutualists
    a=0.2, #probability of assorting on marker
    m0=0.03, #base proportion of each group that migrates
    mu=0, #mean-payoff bias in migration decisions
    s=c(0.2, 0.8), #proportion of total population in each group
    init_p=c(0.9,0.1), #intial proportion of behavior 0 in each group
    init_q=c(0.9,0.1), #intial proportion of marker 0 in each group 
    draw=TRUE )
